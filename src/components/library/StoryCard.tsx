    ...
    >
      ...
      >
        ...
        <div className="pointer-events-none absolute left-2 top-2 flex flex-wrap gap-1">
          {story.isFeatured ? (
            <span className="inline-flex items-center gap-1 rounded-full bg-amber-400/95 px-2 py-1 text-xs font-bold text-amber-950 shadow-sm">
              <Star className="h-3.5 w-3.5" aria-hidden />
              Featured
            </span>
          ) : null}
          {story.isPremium ? (
            <span className="inline-flex items-center gap-1 rounded-full bg-violet-600/95 px-2 py-1 text-xs font-bold text-white shadow-sm">
